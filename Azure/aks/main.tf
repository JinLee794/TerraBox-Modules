...
resource "azurerm_kubernetes_cluster" "this" {
  ...
  linux_profile {
    ...
    ssh_key {
      ...
      key_data = replace(var.public_ssh_key == "" ? data.azurerm_key_vault_secret.public_ssh_key.value : var.public_ssh_key, "\n", "")
    }
  }
  ...
  addon_profile {
    ...
    oms_agent {
      ...
      log_analytics_workspace_id = var.enable_log_analytics_workspace ? azurerm_log_analytics_workspace.this[0].id : null
    }
